...
mom_gen = T.mean(ll.get_output(disc_layers[-2], gen_dat), axis=0)
mom_real = T.mean(ll.get_output(disc_layers[-2], x_unl), axis=0)
...
for epoch in range(300):
    ...
    expname = 'mnist-noali-pimodel-%.4fuw-reg5-ramp50-noaugment-seed%d' % (args.unlabeled_weight, args.seed)
